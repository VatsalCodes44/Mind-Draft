...
import { commentAtomFamily, commentImageAtomFamily, numberOfCommentsFetched, searchedUserAtomFamily, searchedUserImageAtomFamily } from "../store/blogs/atom";
...
const SearchedUserOneBlog = memo(({ blogId, atomNumber }: {blogId: string, atomNumber: number}) => {
    ...
    return (
            <div className="">
                ...
                <div className="flex py-2 border-y-1 border-gray-100 ">
                    <div>
                       <SarchedUserBlogClap blogId={blogId} atomNumber={atomNumber} />
                    </div>
                    <div onClick={() => {
                        ...
                        <div className="text-gray-600 text-sm mt-0.5 group-hover:text-gray-950">{userBlogs[blogId].numberOfComments}</div>
                    </div>
                </div>
                ...
                <div ref={ref1} className="mt-15 text-2xl font-semibold mb-10">
                    Responses ({userBlogs[blogId].numberOfComments})
                </div>
                <div className=" flex"> 
                ...
                <div className="border-b-1 border-gray-100 pb-8 mb-8 mt-6">
                    <MyCommentUpload blogId={blogId} setBlogs={setUserBlogs} />
                </div>
                <div>
                    <CommentsPagination commentRequestNumber={commentRequestNumber} setCommentRequestNumber={setCommentRequestNumber} blogId={blogId} totalComments={userBlogs[blogId].numberOfComments} />
                </div>
            </div>
    )
})

export default SearchedUserOneBlog;
