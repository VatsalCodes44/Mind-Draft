    ...
    return (
        <div role="status" className=" px-4 rounded-sm animate-pulse md:px-5">
            ...
            <div className="flex items-center mt-4 mb-8">
                ...
                <div>
                    <div className="h-4 bg-gray-200 rounded-sm w-32 mb-2"></div>
                    <div className="w-48 h-3 bg-gray-200 rounded-sm "></div>
                </div>
            </div>
            <div className="flex items-center justify-center h-48 mb-4 bg-gray-200 rounded-sm ">
